...
module.exports = async (client, member) => {
    ...
    global.embedify(member.guild.name, member, global.initialWelcomeMessageText(member.guild.name), '#d7141a', welcome + ', ' + member.displayName + '!');

    var channel = await global.findChannels(3, member.guild, ['👋'], ['text']);
